...
export default class PermissionController extends CrudController {
  public create = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(EStatusCodes.OK).json(newPermission);
    } catch (error) {
  ...
  public delete = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(EStatusCodes.OK).json(deletedPermission);
    } catch (error) {
      return res.status(EStatusCodes.BAD_REQUEST).json(error);
    }
  };
  public getAll = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(EStatusCodes.OK).json(permissions);
    } catch (error) {
      return res.status(EStatusCodes.BAD_REQUEST).json(error);
    }
  };
  public getOne = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(EStatusCodes.OK).json(permission);
    } catch (error) {
      return res.status(EStatusCodes.BAD_REQUEST).json(error);
    }
  };
